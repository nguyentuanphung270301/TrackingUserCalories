...
import { Avatar, Box, Button, CircularProgress, FormControlLabel, FormLabel, InputAdornment, Radio, RadioGroup, TextField, Typography } from '@mui/material'
...
const Profile = () => {
    ...
    return (
        <Box sx={{
            ...
            {!loading && (
                <>
                    <Typography variant='h5' fontWeight='500' textTransform='uppercase' sx={{
                        display: 'flex',
